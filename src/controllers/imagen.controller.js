...
const s3 = new AWS.s3({
    accessKeyId='AKIAQB377PUDDVJJX77E',
    secretAccessKey = ''
});
const BUCKET_NAME = 'pruebanicolas';
const IAM_USER_KEY = 'AKIAQB377PUDDVJJX77E';
const IAM_USER_SECRET = '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';
